	...
	<div id="container">
		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				...
				<!--<a rel="facebox" href="addnewproduct.php">Add New Staff</a>-->
					<table cellpadding="1" cellspacing="1" id="resultTable">
						...
						<?php
							include('connect.php');
							$result = mysql_query("SELECT * FROM classtrack");
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="left">'.$row['class'].'</div></td>';
									echo '<td><div align="left">'.$row['unit'].'</div></td>';
									echo '<td><div align="left">'.$row['status'].'</div></td>';
									echo '<td><div align="left">'.$row['ttype'].'</div></td>';
									echo '<td><div align="left">'.$row['tdate'].'</div></td>';
									
								
																		
									//echo '<td><div align="center"><a href="print_pdf.php?dname='.$row['fname'].'" target="blank"><img alt="Statistics" src="img/accept.png" title="print report"/></a> </div></td>';
									echo '<td><div align="center"><a rel="facebox" href="see.php?id='.$row['ID'].'" title="view Hours attended">Taught</a> | <a rel="facebox" href="see2.php?id='.$row['ID'].'" title="view Hours attended">Missed</a> || <a href="#" id="'.$row['ID'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
