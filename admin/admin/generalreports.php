		...
		<div id="panel-outer" class="radius" style="opacity: 1" style="margin-top:10%">
			<div id="panel" class="radius" >
				...
				<div id="content" class="clearfix">
					...
					<a  href="">List of all incidences reported in our system</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="left">'.$row['survivor_contact_phone_number'].'</div></td>';
									echo '<td><div align="left">'.$row['incident_date_and_time'].'</div></td>';
								
									
									
									
									echo '<td><div align="center"><a target="_blank" href="print_pdf.php?id='.$row['incident_report_id'].'">PDF</a> </div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
