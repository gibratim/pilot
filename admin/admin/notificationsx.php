	...
	<div id="container">
		...
		<div id="panel-outer" class="radius" style="opacity: 1" style="margin-top:10%">
			...
			<table cellpadding="1" cellspacing="1" id="resultTable">
						...
						<?php
							include('connect.php');
							$result = mysql_query("SELECT * FROM dashboardactivity");
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="left">'.$row['count'].'</div></td>';
									
									
									echo '<td><div align="left">'.$row['cdatse'].'</div></td>';
									
								
																		
									echo '<td><div align="left"><a rel="facebox" href="see.php?id='.$row['ID'].'" title="view Details">View the activity Details</a>  </div></td>';
									//echo '<td><div align="center"><a rel="facebox" href="editclasstrack.php?id='.$row['ID'].'">Archieve</a>| <a href="#" id="'.$row['ID'].'" class="delbutton" title="Click To Pudh to National Database">Push</a> | <a href="#" id="'.$row['ID'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
