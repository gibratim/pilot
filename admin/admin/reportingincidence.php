...
<tr><td>Perpetrator relationship:<input name="rel" type="text" class="ed" /></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td>N0.of perpetrators: <input name="nop" type="text" class="ed" /></td></tr>
<tr><td>Perpetrator's name: <input name="pname" type="text" class="ed" /></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td>Perpetrator's age: <input name="page" type="text" class="ed" /></td></tr>
